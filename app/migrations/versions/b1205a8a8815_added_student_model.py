...
Revision ID: b1205a8a8815
Revises: e0a96bf25bfe
Create Date: 2023-08-30 20:58:52.691295
...
revision = 'b1205a8a8815'
down_revision = 'e0a96bf25bfe'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.CheckConstraint('grade BETWEEN 1 AND 2', name='grade_between_1_and_12'),
